...
export function ThemeToggle() {
  ...
  const getIcon = () => {
    switch (theme) {
      ...
      case 'dark':
        return (
          <Moon className="h-[1.2rem] w-[1.2rem] rotate-90 scale-0 transition-all duration-1000 dark:rotate-0 dark:scale-100" />
        );
      case 'system':
      default:
        return (
          <Monitor className="h-[1.2rem] w-[1.2rem] transition-all duration-1000 theme-icon" />
        );
    }
  };
