  ...
  return (
    ...
    >
          <motion.div
            ...
            className="modal-content modal-rounded relative w-full max-w-2xl max-h-[calc(100vh-3rem)] sm:max-h-[calc(100vh-4rem)] min-h-[300px] bg-white shadow-2xl outline-none flex flex-col"
          ...
          >
                ...
                <Card>
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        <label className="text-sm font-medium text-gray-500">日语</label>
                        <div className="flex items-center space-x-2 mt-1">
                          <span className="text-2xl sm:text-3xl font-medium text-gray-900 japanese-text">
                    ...
                    {/* Reading */}
                    <div>
                      <label className="text-sm font-medium text-gray-500">读音</label>
                      <div className="flex items-center space-x-2 mt-1">
                    ...
                    {/* Chinese Meaning */}
                    <div>
                      <label className="text-sm font-medium text-gray-500">中文意思</label>
                      <div className="flex items-center space-x-2 mt-1">
                ...
                <Card>
                  ...
                  <CardContent className="space-y-3">
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
                      <div>
                        <label className="text-sm font-medium text-gray-500">课程</label>
                        <p className="text-gray-900">{vocabulary.lesson_name}</p>
                      </div>
                      <div className="text-right">
                        <label className="text-sm font-medium text-gray-500">书籍ID</label>
                        <p className="text-gray-900">{vocabulary.book_id}</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
                      ...
                      <div className="space-y-4">
                        {vocabulary.example_sentences.map((sentence, index) => (
                          ...
                          >
                            ...
                            <p className="text-gray-900 japanese-text">{sentence}</p>
                          </div>
                        ))}
                      </div>
                    </CardContent>
                ...
                <Card>
                  ...
                  <CardContent>
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
                      <div>
                        <label className="font-medium text-gray-500">词性</label>
                        <p className="text-gray-900">{vocabulary.part_of_speech}</p>
                      </div>
                      <div>
                        <label className="font-medium text-gray-500">例句数量</label>
                        <p className="text-gray-900">{vocabulary.example_sentences?.length || 0} 个</p>
                      </div>
                      <div>
                        <label className="font-medium text-gray-500">课程ID</label>
                        <p className="text-gray-900">{vocabulary.lesson_id}</p>
                      </div>
                      <div>
                        <label className="font-medium text-gray-500">单词编号</label>
                        <p className="text-gray-900">{vocabulary.word_number}</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
            ...
            {/* Footer Actions */}
            <div className="modal-footer flex flex-col sm:flex-row gap-3 px-6 py-4 sm:px-8 sm:py-5 border-t bg-gray-50 flex-shrink-0 items-center">
